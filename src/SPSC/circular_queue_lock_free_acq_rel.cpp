...
template <typename T>
CircularQueueLockFreeAcqRel<T>::CircularQueueLockFreeAcqRel(size_t capacity)
...
template <typename T>
CircularQueueLockFreeAcqRel<T>::~CircularQueueLockFreeAcqRel() {
  while (!is_empty()) {
...
template <typename T>
bool CircularQueueLockFreeAcqRel<T>::Push(const T &element) {
...
template <typename T> bool CircularQueueLockFreeAcqRel<T>::Pop() {
...
template <typename T> const T &CircularQueueLockFreeAcqRel<T>::Front() {
  return front();
}
...
template <typename T> size_t CircularQueueLockFreeAcqRel<T>::Size() {
  return size();
}
...
template <typename T> bool CircularQueueLockFreeAcqRel<T>::IsEmpty() {
  return is_empty();
}

template <typename T> bool CircularQueueLockFreeAcqRel<T>::is_empty() {
  return size() == 0;
}

template <typename T> bool CircularQueueLockFreeAcqRel<T>::IsFull() {
  return is_full();
}

template <typename T> bool CircularQueueLockFreeAcqRel<T>::is_full() {
  return size() == capacity_;
}

template <typename T> void CircularQueueLockFreeAcqRel<T>::Close() { close(); }

template <typename T> void CircularQueueLockFreeAcqRel<T>::close() {
  is_closed_.store(true, std::memory_order_release);
}

template <typename T> bool CircularQueueLockFreeAcqRel<T>::IsFinished() {
  return is_finished();
}

template <typename T> bool CircularQueueLockFreeAcqRel<T>::is_finished() {
  auto is_closed = is_closed_.load(std::memory_order_acquire);

  return is_closed_ && is_empty();
}

template <typename T> void CircularQueueLockFreeAcqRel<T>::Print() {
